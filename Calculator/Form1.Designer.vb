...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ' BtnCE
        ' 
        BtnCE.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        ...
        ' BtnC
        ' 
        BtnC.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        ...
        ' BtnMultiply
        ' 
        BtnMultiply.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        ...
        ' BtnMinus
        ' 
        BtnMinus.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
        ...
        ' BtnPlus
        ' 
        BtnPlus.BackColor = Color.FromArgb(CByte(224), CByte(224), CByte(224))
